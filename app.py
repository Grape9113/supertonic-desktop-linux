...
class TTSApp:
    ...
    def _synthesize_and_play(self, text: str) -> None:
        try:
            ...
            cmd = ["supertonic", "tts", text, "--voice", voice, "-o", str(wav_path)]
            subprocess.run(cmd, check=True, capture_output=True, text=True)

            play_cmd = ["ffplay", "-nodisp", "-autoexit", "-loglevel", "error", str(wav_path)]
            subprocess.run(play_cmd, check=True, capture_output=True, text=True)
